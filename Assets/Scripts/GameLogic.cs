...
public class GameLogic : MonoBehaviour {
	...
	public void startPuzzle() { //Begin the puzzle sequence
		...
		startAudioHolder.GetComponent<GvrAudioSource>().Stop();
	...
	public void finishingFlourish() { //A nice visual flourish when the player wins
		successAudioHolder.GetComponent<GvrAudioSource>().Play(); //Play the success audio
		handOk.SetActive(true);
